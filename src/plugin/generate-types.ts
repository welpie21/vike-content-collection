...
export async function generateDeclarationFile(
	...
	const outDir = declarationOutDir
		? join(projectRoot, declarationOutDir)
		: join(projectRoot, GENERATED_DIR);
	const outFile = join(outDir, declarationFileName ?? GENERATED_FILE);

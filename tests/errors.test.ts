...
describe('ContentCollectionError', () => {
  ...
  it('formats message with file path, line, and column', () => {
    const err = new ContentCollectionError('missing key', '/pages/post.md', 3, 10)
...
describe('formatValidationErrors', () => {
  it('formats a single issue with line and path', () => {
    ...
    expect(result).toContain('[vike-content-collection] Schema validation failed:')
    expect(result).toContain('/pages/blog/post.md:2 (at "title"): Expected string, received number')
  })
